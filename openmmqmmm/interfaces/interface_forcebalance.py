...
class ForceBalance:
 ...
 """
    ...
    def run(self, debug=False, continue_=False):
        ...
        xmlfile = write_xmlfile(filename=self.forcefield_name, resnames=["DUM"], atomnames_per_res=[atomnames_full],
                                atomtypes_per_res=[self.fragment.elems],
                                elements_per_res=[self.fragment.elems], masses_per_res=[self.fragment.masses],
                                charges_per_res=[[0.0] * self.fragment.numatoms],
                                sigmas_per_res=[[0.0] * self.fragment.numatoms],
...
################################
def write_xmlfile(resnames=None, atomnames_per_res=None, atomtypes_per_res=None, elements_per_res=None,
