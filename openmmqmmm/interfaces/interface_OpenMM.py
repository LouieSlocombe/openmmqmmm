...
from openmmqmmm.functions.functions_general import ashexit, BC, print_time_rel, listdiff, printdebug, \
...
from openmmqmmm.modules.module_MM import UFF_modH_dict, MMforcefield_read
    ...
    if version.parse(openmm.__version__) >= version.parse("8.1") and use_reporter is True:
        class Reporter(openmm.openmm.MinimizationReporter):
            ...
            def print_energy(self, args):
                ...
                # self.energy = self.state.getPotentialEnergy().value_in_unit_system(openmm.unit.md_unit_system) / openmmqmmm.constants.hartokj
