...
from ash.functions.functions_general import ashexit, blankline, BC, print_time_rel, print_line_with_mainheader, \
    print_line_with_subheader1, print_if_level
...
from ash.modules.module_coords import print_coords_for_atoms, print_internal_coordinate_table, write_XYZ_for_atoms, \
    ...
    def hessian_option(self, fragment, actatoms, theory, charge, mult, modelhessian):
        ...
        if type(self.hessian) == np.ndarray:
            ...
            if self.hessian == "xtb":
                ...
                hessianfile = calc_hessian_xtb(fragment=fragment, actatoms=atomsused, numcores=theory.numcores,
                                               use_xtb_feature=True, charge=charge, mult=mult)
                self.hessian = "file:" + hessianfile
