...
from ash.functions.functions_general import ashexit, BC, pygrep
...
def calc_DFTD4(fragment=None, functional=None, Grad=True, printlevel=2):
    try:
        ...
        print(
            "Problem importing dftd4 python package. Make sure you have installed dftd4-python (and dftd4) in this environment: See: https://github.com/dftd4/dftd4")
...
def calc_gcp(fragment=None, xyzfile=None, current_coords=None, elems=None, functional=None, Grad=True, printlevel=2):
    ...
    if shutil.which('mctc-gcp') is None:
        print(
            "Problem finding mctc-gcp binary in PATH. Make sure you have installed conda-forge package gcp-correction in this environment: See: https://github.com/grimme-lab/gcp")
    ...
    if fragment is not None:
        ...
        with open("gcpgeo.xyz") as fh:
            numatoms = int(next(fh))
