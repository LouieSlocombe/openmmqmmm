...
class TorchTheory():
    ...
    def load_aimnet_model(self, model_name=None, model_file=None, aimnet_mode="old"):
        ...
        if aimnet_mode == "old":
            ...
            try:
                ...
                print(
                    "Problem importing AIMNet2Calculator or torch libraries. Make sure you have installed AIMNet2 correctly")
                ashexit()
            ...
            try:
                ...
                print("Import error message:", e)
                print(
                    "Problem importing AIMNet2ASE, ase or torch libraries. Make sure you have installed AIMNet2 correctly")
    ...
    def run(self, current_coords=None, current_MM_coords=None, MMcharges=None, qm_elems=None, mm_elems=None,
        ...
        if 'aimnet2' in str(self.model).lower() and self.aimnet_mode == "old":
            input_data = {'coord': current_coords, 'numbers': elemstonuccharges(qm_elems), 'charge': charge,
                          'mult': mult}
            ...
            if Hessian:
                self.hessian = (0.03674932217565499 / 1.88972612546 / 1.88972612546) * results[
        ...
        # TorchANI
            ...
            coords_torch = torch.tensor(np.array([current_coords], dtype='float32'), requires_grad=True,
                                        device=self.device)
