...
from openmmqmmm.dictionaries_lists import atom_core_electrons
from openmmqmmm.functions.functions_general import BC, ashexit, writestringtofile, print_line_with_mainheader
...
def multiwfn_run(moldenfile, fchkfile=None, option='density', num_frozen_orbs='Auto', mrccoutputfile=None,
                 mrccdensityfile=None, multiwfndir=None, grid=3, numcores=1,
...
http://onlinelibrary.wiley.com/doi/10.1002/jcc.22885/abstract
    ...
    shutil.copy(f"{openmmqmmm.ashpath}/external/Multiwfn/settings.ini", "settings.ini")
    ############################
    ...
    if multiwfndir == None:
        print(BC.WARNING,
              ...
              BC.END)
        try:
            multiwfndir = openmmqmmm.settings_ash.settings_dict["multiwfndir"]
        except:
    ...
    if moldenfile != None:
        ...
        molden_dict = openmmqmmm.functions.functions_elstructure.read_molden_file(moldenfile)
