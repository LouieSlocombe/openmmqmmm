...
from ash.functions.functions_general import ashexit, print_time_rel, BC, \
    print_line_with_mainheader
from ash.modules.module_coords import check_multiplicity
...
class BigDFTTheory:
    def __init__(self, printlevel=2, filename='bigdft_', maxiter=500, electronic_temp=300, label=None,
        ...
        if rmult is None:
            print(
                "Warning: rmult is not set. Should typically be given as a list of 2 int/float numbers (meaning coarse and fine grid)")
    ...
    def run(self, current_coords=None, current_MM_coords=None, MMcharges=None, qm_elems=None, mm_elems=None,
        ...
        if Grad == True:
            ...
            print_time_rel(module_init_time, modulename='BigDFT run', moduleindex=2, currprintlevel=self.printlevel,
                           currthreshold=1)
