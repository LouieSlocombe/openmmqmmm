...
"""
    ...
    def cleanup(self):
        ...
        list_files.append(self.filename + '.bibtex')
        list_files.append(self.filename + '.densitiesinfo')
        list_files.append(self.filename + '.pc')
        list_files.append(self.filename + '.pcgrad')
        list_files.append(self.filename + '.property.txt')
        list_files.append(self.filename + '.gbw')
        list_files.append(self.filename + '.gbw_hs')
