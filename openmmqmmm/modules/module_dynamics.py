...
def MolecularDynamics(fragment=None, theory=None, ensemble="NVE", timestep=1, numsteps=100, temperature=298.15, tau=500,
                      thermostat="berendsen", write_xyz_frequency=1, write_log_frequency=1,
                      write_userfunction_frequency=100, MDtrajname="trajectory.xyz",
    ...
    simobject = Simulation(ensemble=ensemble, timestep=timestep, numsteps=numsteps, set_temperature=298.15,
                           thermostat=thermostat, tau=tau)
