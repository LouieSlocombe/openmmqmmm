...
from openmmqmmm.functions.functions_general import print_line_with_mainheader, ashexit
...
def reactionprofile_plot(surfacedictionary, finalunit=None, label='Label', x_axislabel='Coord', y_axislabel='Energy',
                         dpi=200, mode='pyplot',
