...
from ash.modules.module_coords import print_coords_all
...
class NumGradclass:
    ...
    def run(self, current_coords=None, current_MM_coords=None, MMcharges=None, qm_elems=None, mm_elems=None,
        ...
        if self.runmode == "serial":
            ...
            origfrag = ash.Fragment(coords=current_coords, elems=elems, label="orig", printlevel=0, charge=charge,
                                    mult=mult)
            all_disp_fragments = [origfrag] + all_disp_fragments
            result = ash.functions.functions_parallel.Job_parallel(fragments=all_disp_fragments, theories=[self.theory],
